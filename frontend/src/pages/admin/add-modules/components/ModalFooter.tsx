    ...
    <div className="border-t bg-gray-50 px-6 md:px-8 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        {currentStep < 4 ? (
          ...
          <button
            onClick={onPublish}
            className="px-6 py-3 bg-[#1A3D2D] hover:bg-green-900 text-white rounded-lg cursor-pointer font-semibold hover:from-green-700 hover:to-emerald-700 transition-all shadow-md hover:shadow-lg flex items-center gap-2"
          >
            <span>✓</span>
            Publish Module
          </button>
